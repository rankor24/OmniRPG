import type { Character, ChatMessage, AppSettings, ChatSceneState, AiResponse, Lorebook, Status, Persona, Memory, Reflection, PromptTemplate, RpgGameState } from '../types';
...
export const getAiResponse = async (
  ...
  const modelToUse = appSettings.aiProvider === 'groq' ? appSettings.aiModel : 'llama-3.1-8b-instant';
